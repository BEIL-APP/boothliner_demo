...
export const SEED_BOOTHS: Booth[] = [
  {
    ...
    description:
      '국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.국내 최고의 산지에서 직접 수확한 유기농 차를 선보입니다. 하동 녹차부터 보성 홍차까지, 기업 복지 선물 세트와 사무실 웰니스 구독 패키지를 제공합니다. 연간 계약 시 커스텀 패키징과 브랜드 라벨링이 가능합니다.',
    images: [
